    ...
    return (
        ...
        <div className="container-narrow">
          <div className="row">
            ...
            <div className="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img className="avatar img-fluid mt-2" src={AvatarImage} width="400" height="400" alt="Walter Patterson"/></div>
          </div>
        </div>
      </div> 
    );
